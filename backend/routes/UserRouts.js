...
router.route("/:id").delete(authenticate, authrizeAdmin, deleteUserById).get(authenticate, authrizeAdmin, getUserById).put(authenticate, authrizeAdmin, UpdateUserById);
